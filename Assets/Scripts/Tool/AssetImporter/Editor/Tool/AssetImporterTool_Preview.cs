...
internal sealed class AssetImporterTool_Preview : EditorWindow
{
    ...
    private static void SetOption(AssetImporterTool_Preview tool)
    {
    ...
    private void DrawMenus()
    {
        ...
        Btn("압축 포맷 별로 보기", () => AssetImporterTool_FormatWindow.Open(_assetInfo));
